...
export function exportRendicionToPDF(
  ...
  if (company.logoUrl) {
    try {
      ...
      doc.circle(22, 13, 8, 'F');
      doc.addImage(company.logoUrl, 'PNG', 15, 6, 14, 14);
  ...
  doc.text(`Telf: ${company.telefono}  |  Sistema Contable: ${company.sistemaContableExport}`, textStartX, 22);
